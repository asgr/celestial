cosvol=function(area=60, zmax=1, zmin=0, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, inunit='deg2', ref){
  ...
  vols=cosdistCoVol(z=c(zmin,zmax), H0 = H0, OmegaM = OmegaM, OmegaL = OmegaL, OmegaR=OmegaR)
